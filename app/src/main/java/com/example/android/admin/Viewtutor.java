    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener (new AdapterView.OnItemClickListener ( ) {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(Viewtutor.this);
                ...
                alertDialog.setPositiveButton("MODIFY", new DialogInterface.OnClickListener() {
                    ...
                    public void showInputBox(String oldItem, final int index){
                        final Dialog dialog=new Dialog (Viewtutor.this);
                ...
                alertDialog.setNegativeButton("DELETE", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,	int which) {
                        ...
                        Toast.makeText(getApplicationContext(), "Tutor has been Removed!", Toast.LENGTH_SHORT).show();
                        dialog.cancel();
                    }
                });
