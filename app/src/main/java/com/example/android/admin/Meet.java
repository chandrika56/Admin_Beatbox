    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener (new AdapterView.OnItemClickListener ( ) {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(Meet.this);
                ...
                alertDialog.setPositiveButton("MODIFY", new DialogInterface.OnClickListener() {
                    ...
                    public void showInputBox(String oldItem, final int index){
                        final Dialog dialog=new Dialog (Meet.this);
                ...
                alertDialog.setNeutralButton ("COMPLETED", new DialogInterface.OnClickListener ( ) {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        startActivity (new Intent (Meet.this,Meet.class));
                        Toast.makeText(getApplicationContext(), "Your Meetup has been completed!", Toast.LENGTH_SHORT).show();
